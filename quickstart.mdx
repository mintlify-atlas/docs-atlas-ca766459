...
<Steps>
  ...
  <Step title="Make your first authenticated request">
    ...
    <Tip>
      Open the interactive Swagger UI at [http://localhost:8080/swagger-ui.html](http://localhost:8080/swagger-ui.html) to browse and try all available endpoints without leaving your browser. Use the **Authorize** button to paste your token once and have it applied to every request automatically.
    </Tip>
  </Step>
</Steps>
