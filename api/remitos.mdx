...
description: "Create and manage dispatch notes (remitos) that record food deliveries to institutions. Supports date-range filtering and full pagination over delivery records."
---
