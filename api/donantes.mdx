---
title: "Donantes API — manage Banco Alimentos donor companies"
sidebarTitle: "Donantes"
description: "Create, read, update, and delete donor records for the food bank, and retrieve full audit history for any donor — secured by role-based authorities."
---
...
Returns an array of [DonanteResponseDTO](#donante-response-schema) objects with HTTP `200 OK`.
...
Returns a single [DonanteResponseDTO](#donante-response-schema) object with HTTP `200 OK`. Throws `404` if the donor is not found.
